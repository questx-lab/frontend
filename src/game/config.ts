	...
	game: {
		...
		quests: {
			ERGBHJ98: {
				...
				imsiHandler: false,
				goalOrder: {
					id3: { optional: true, break: true, dialog: ['Welcome to my xquest! Do you need some help ?', 'Oh yes! The neighbourhood is really nice and quiet. I used to walk around here and enjoy my time.', 'Only once I heard someone shout "123456789". I didn\'t understand why...', 'Well, see you later.'] },
					id10: {
						break: true,
						dialog: [
							'Welcome to Xquest',
