...
export class Sign extends Phaser.GameObjects.Zone {
  ...
  text: any
  activated: boolean
  constructor(scene: any, x: number, y: number, text: any, direction: any) {
  ...
  collideSign(player: {
    body: { touching: { left: any; right: any; up: any; down: any } }
  }) {
    if (!this.activated) {
  ...
  playerMovement(moveleft: any, moveright: any, moveup: any, movedown: any) {
