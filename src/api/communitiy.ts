...
export const getLeaderboardApi = async (
  ...
  try {
    ...
    const data: LeaderboardType[] = [
      {
        user: {
          id: 'f4b8f54d-d94b-4a22-8cef-7265416e0e80',
          name: 'adata dkslad dsjadlk jdlksa',
          wallet_address: '',
          role: '',
          services: {},
          referral_code: 'KSyIgZrCU',
          is_new_user: false,
          avatar_url: '',
          total_communities: 0,
          total_claimed_quests: 0,
        },
        value: 100,
        current_rank: 1,
        previous_rank: 0,
      ...
      {
        user: {
          id: 'a32bd1b8-ae58-465c-bdb3-6e6037dd8fb7',
          name: 'kkkk',
          wallet_address: '',
          role: '',
          services: {},
          referral_code: 'dwoaornJK',
          is_new_user: false,
          avatar_url: '',
          total_communities: 0,
          total_claimed_quests: 0,
      ...
      {
        user: {
          id: '614304ee-3f55-41ad-9d08-f5112d6ab350',
          name: 'hahah',
          wallet_address: '',
          role: '',
          services: {},
          referral_code: 'eLEFvgNcZ',
          is_new_user: false,
          avatar_url: '',
          total_communities: 0,
          total_claimed_quests: 0,
