...
export const QuestDetailModal: FunctionComponent<{
  ...
  return (
    <TemplateModal isOpen={isOpen} onClose={onClose} title={quest?.title || ''}>
      <div className='grid gap-2 grid-cols-2 overscroll-none divide-x-2 h-max'>
        <div className='text-left p-6'>
          ...
          <Description>
            ...
            leo dui. Sed porttitor augue erat, a hendrerit neque viverra et.
          </Description>
          <Gap height={4} />
          <Title>Guild</Title>
          <Gap height={2} />
